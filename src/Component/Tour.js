    ...
    <div onClick={closeNav}>
      ...
      <div className='mapHeading'><h1 style={{textAlign:"center",color:"rgb(108, 108, 108)", fontSize:"45px"}}>Our Destinations</h1></div>
          ...
          <svg baseprofile="tiny"
            ...
            <Link to={'/MiddleEast'}>
              <path
                ...
                id="mEast" name="United Arab Emirates">
              </path>
            </Link>
            ...
            <Link to={'/MiddleEast'}>
              <path
                ...
                id="mEast" name="Armenia">
              </path>
            </Link>
            <path class="Australia" id='At'
            ...
            <Link to={'/Europe'}>
              <path
                ...
                id='europe' name="Austria">
              </path>
            </Link>
            <Link to={'/MiddleEast'}>
              <path class="Azerbaijan" id="mEast"
            ...
            <Link to={'/SouthEastAsia'}>
              <path d="M1633.1 472.8l2.2-2.4 4.6-3.6-0.1 3.2-0.1 4.1-2.7-0.2-1.1 2.2-2.8-3.3z" id="sEast"
            ...
            <Link to={'/Europe'}>
              <path
                ...
                id="europe" name="Switzerland">
              </path>
            </Link>
            <Link to={'/Asia'}>

              <path class="China" id='bht'
            ...
            <path
              ...
              id="afr" name="Djibouti">
            </path>
            <Link to={'/Europe'}>
              <path class="Denmark" id='europe' d="M 1046.1 147.7 1043.7 152.6 1038.5 149.1 1037.6 146.6 1044.4 144.6 1046.1 147.7 Z">
              </path>
              <path class="Denmark" id='europe'
            ...
            <Link to={'/Europe'}>
              <path class="United Kingdom" id='europe'
            ...
            <Link to={'/Africa'}>
              ...
              <path
                ...
                id="afr" name="Guinea-Bissau">
              </path>
            </Link>
            <path d="M1050.3 487.3l0 7.7-8.2 0-1.9 0.3-1.1-0.9 1.9-7.2 9.3 0.1z" id="afr" name="Equatorial Guinea">
            </path>
            <Link to={'/Europe'}>
              <path class="Greece" id='europe'
            ...
            <Link to={'/Europe'}>
              <path
                ...
                id="europe" name="Hungary">
              </path>
            </Link>

            <Link to={'/SouthEastAsia'}>

              <path class="Indonesia" id="sEast"
              ...
              <path class="Indonesia" id="sEast" d="M 1707.3 524 1705.1 526.2 1701.3 525 1700.3 522.2 1706 521.9 1707.3 524 Z">
              </path>
              <path class="Indonesia" id="sEast"
            ...
            <Link to={'/MiddleEast'}>
              <path
                ...
                id="mEast" name="Jordan">
              </path>
            </Link>
            <Link to={'/Asia'}>
              <path class="Japan" id="bht"
            ...
            <Link to={'/Asia'}>
              <path
                ...
                id="bht" name="Republic of Korea">
              </path>
            </Link>
            <Link to={'/MiddleEast'}>
              <path d="M1247.5 309.4l1.5 2.8-0.3 1.5 2.4 4.8-3.9 0.2-1.7-3.1-5-0.6 3.3-6.2 3.7 0.6z" id="mEast" name="Kuwait">
              </path>
            </Link>
            <Link to={'/SouthEastAsia'}>
              <path
            ...
            <path d="M1445.9 462l-4.8 1.5-2.9-5.1-1.4-9.2 2-10.4 4.1 3.5 2.8 4.5 3.1 6.7-0.6 6.7-2.3 1.8z" id="bht"
              name="Sri Lanka">

            </path>
            <path d="M1139.1 697.9l-2 0.7-3.7-5 3.2-4 3.1-2.5 2.7-1.4 2.2 2 1.7 2-1.9 3.1-1.1 2.1-3.1 1-1.1 2z" id="afr"
              name="Lesotho">
            </path>
            <Link to={'/Europe'}>
              <path
                ...
                id="europe" name="Lithuania">
              </path>
            </Link>
            <path d="M1016.9 185.4l-1.4 0.1-1.1-0.5 0.4-3.5 1.3-0.2 1 1.4-0.2 2.7z" id="europe" name="Luxembourg">
            </path>
            <Link to={'/Europe'}>
              <path
            ...
            <Link to={'/MiddleEast'}>
              ...
              <path class="Oman" id="mEast" d="M 1296.2 336.7 1294.9 334.5 1296.3 332.4 1297 332.9 1296.8 335.6 1296.2 336.7 Z">
              </path>
            </Link>
            <path
            ...
            <Link to={'/SouthEastAsia'}>
              ...
              <path class="Philippines" id="sEast"
              ...
              <path class="Philippines" id="sEast" d="M 1670.2 417.9 1669.3 423.5 1666.6 420.3 1663.1 415.4 1667.9 415.6 1670.2 417.9 Z">
              </path>
              <path class="Philippines" id="sEast"
              ...
              <path class="Papua New Guinea" id="sEast"
            ...
            <Link to={'/Europe'}>
              ...
              <path
                ...
                id="europe" name="Sweden">
              </path>
            </Link>
            <path d="M1161.7 667.7l0.6 2.9 0.3 2.9-1.4 2.8-3.2 0.7-3.1-3.5 0.1-2.2 1.7-2.4 0.6-1.9 1.7-0.4 2.7 1.1z" id="afr"
              name="Swaziland">
            </path>
            <Link to={'/MiddleEast'}>
              <path
            ...
            <Link to={'/MiddleEast'}>
              <path
                ...
                id="mEast" name="Turkmenistan">
              </path>
            </Link>

            <Link to={'/SouthEastAsia'}>
              <path d="M1692.7 562.1l0.1-1.9-0.5-1.3 0.8-1.5 4.9-1.4 4-0.3 1.8-0.8 2.1 0.8-2.2 1.8-6.1 2.8-4.9 1.8z" id="sEast"
                name="Timor-Leste">
              </path>
            </Link>
            ...
            <Link to={'/Europe'}>
              <path
                ...
                id="europe" name="Spain">
              </path>

              <path class="France" id='europe'
            ...
            <Link to={'/SouthEastAsia'}>
              ...
              <path class="Solomon Islands" id="sEast"
              ...
              <path class="Solomon Islands" id="sEast" d="M 1900.8 564 1900.7 564.2 1900.7 564.9 1900.5 564.7 1900.5 564.2 1900.8 564 Z">
              </path>
              <path class="Solomon Islands" id="sEast"
              ...
              <path class="Solomon Islands" id="sEast" d="M 1876.7 557.7 1876.9 558 1876.8 558.3 1876 557.9 1876.5 557.6 1876.7 557.7 Z">
              </path>
              <path class="Solomon Islands" id="sEast"
              ...
              <path class="Solomon Islands" id="sEast" d="M 1874.3 555.2 1874.1 554.8 1873.8 554.5 1874.2 554.5 1874.3 555.2 Z">
              </path>
              <path class="Solomon Islands" id="sEast"
              ...
              <path class="Solomon Islands" id="sEast" d="M 1877 549.3 1877.5 549.3 1877.3 549.5 1877 549.4 1877 549.3 Z">
              </path>
              <path class="Solomon Islands" id="sEast" d="M 1881.3 549.3 1881.1 549.8 1881 549.6 1881.3 549.3 Z">
              </path>
              <path class="Solomon Islands" id="sEast"
              ...
              <path class="Solomon Islands" id="sEast" d="M 1869.3 546 1869.3 546.5 1869.1 546.3 1869.1 546.1 1869.3 546 Z">
              </path>
              <path class="Solomon Islands" id="sEast"
        ...
        <div className="symbolDetails">
          ...
          <label htmlFor="">Middle-East</label>
